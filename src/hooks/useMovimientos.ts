...
export const useMovimientos = (): UseMovimientosReturn => {
  ...
  }, [lazyState.page, lazyState.rows, filtros.fechaDesde, filtros.fechaHasta, filtros.tipoMovimientoFiltro, filtros.categoriaFiltro, filtros.depositoFiltro, debouncedGlobalFilter]);
  ...
  useEffect(() => {
    ...
    fetchDepositos();
  }, [fetchCategorias, fetchTiposMovimiento, fetchDepositos]);
